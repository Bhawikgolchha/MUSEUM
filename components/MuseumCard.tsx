...
import { MapPin, Clock, Ticket, Sparkles, Navigation, CheckCircle2, ChevronRight, Eye } from 'lucide-react';
...
export default function MuseumCard({
  ...
  return (
    <div
      onClick={onSelect}
      className={`group flex flex-col sm:flex-row gap-4 p-4 rounded-2xl bg-[var(--paper-raised)] border transition-all duration-200 cursor-pointer shadow-2xs ${
        isSelected
        ...
        <div className="pt-2 border-t border-[var(--rule)]/60 flex flex-wrap items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-3 py-1.5 rounded-lg text-xs font-semibold text-[var(--ink)] bg-[var(--rule)]/40 hover:bg-[var(--rule)]/80 transition-colors min-h-[36px]"
            >
              Details
            </button>
